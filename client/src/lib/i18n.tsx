...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "formations.priceFrom": "À partir de",
    ...
    "agent.commercialTitle": "Commercial",
    "agent.commercialTitleFemale": "Commerciale",
    "agent.advisorDedicated": "Votre conseiller dédié",
    "agent.advisorDedicatedFemale": "Votre conseillère dédiée",
    "agent.greeting": "Bonjour, je m'appelle",
    "agent.roleIntro": "Je suis votre conseiller commercial A.SAP Consulting. En quoi puis-je vous aider ?",
    "agent.roleIntroFemale": "Je suis votre conseillère commerciale A.SAP Consulting. En quoi puis-je vous aider ?",
    "agent.quickAction.rdv": "Prendre RDV",
    "agent.quickAction.meet": "Google Meet",
    "agent.quickAction.teams": "Teams",
    "agent.quickAction.rdvPrompt": "Je souhaite prendre un rendez-vous avec un consultant.",
    "agent.quickAction.meetPrompt": "Je voudrais organiser une réunion Google Meet.",
    "agent.quickAction.teamsPrompt": "Je préfère une réunion Microsoft Teams.",
    "agent.suggested.deploy": "Je veux déployer SAP dans mon entreprise",
    "agent.suggested.formations": "Quelles formations SAP proposez-vous ?",
    "agent.suggested.audit": "J'ai besoin d'un audit de mon SI",
    "agent.suggested.accompagnement": "Comment fonctionne votre accompagnement ?",
    "agent.booking.invite": "Parfait ! Je vous propose de réserver un créneau pour une consultation Google Meet de 15 minutes avec notre équipe.",
    "agent.booking.chooseSlot": "Choisissez votre date et heure dans le calendrier ci-dessous :",
    "agent.booking.selectDate": "Sélectionnez une date",
    "agent.booking.availableSlots": "Créneaux disponibles",
    "agent.booking.confirmSlot": "Confirmer ce créneau",
    "agent.booking.yourSlot": "Votre créneau",
    "agent.booking.enterEmail": "Entrez votre email pour recevoir l'invitation",
    "agent.booking.emailPlaceholder": "votre@email.com",
    "agent.booking.confirmBooking": "Confirmer la réservation",
    "agent.booking.creating": "Création de votre réunion...",
    "agent.booking.success": "Réunion confirmée !",
    "agent.booking.date": "Date",
    "agent.booking.email": "Email",
    "agent.booking.joinMeet": "Rejoindre Google Meet",
    "agent.booking.successMessage": "Excellent ! Votre réunion Google Meet a été créée avec succès ! Une invitation a été envoyée à",
    "agent.booking.lookingForward": "Je me réjouis de vous retrouver pour cette consultation. Nous discuterons de vos besoins et vous présenterons les meilleures solutions A.SAP Consulting pour votre projet.",
    "agent.booking.seeYouSoon": "À très bientôt !",
    "agent.booking.error": "Désolé, une erreur s'est produite lors de la création de la réunion. Veuillez réessayer ou nous contacter directement.",
  ...
  en: {
    ...
    "agent.commercialTitle": "Sales Representative",
    "agent.commercialTitleFemale": "Sales Representative",
    "agent.advisorDedicated": "Your dedicated advisor",
    "agent.advisorDedicatedFemale": "Your dedicated advisor",
    "agent.greeting": "Hello, my name is",
    "agent.roleIntro": "I'm your A.SAP Consulting sales advisor. How can I help you?",
    "agent.roleIntroFemale": "I'm your A.SAP Consulting sales advisor. How can I help you?",
    "agent.quickAction.rdv": "Book Meeting",
    "agent.quickAction.meet": "Google Meet",
    "agent.quickAction.teams": "Teams",
    "agent.quickAction.rdvPrompt": "I would like to book a meeting with a consultant.",
    "agent.quickAction.meetPrompt": "I would like to schedule a Google Meet meeting.",
    "agent.quickAction.teamsPrompt": "I prefer a Microsoft Teams meeting.",
    "agent.suggested.deploy": "I want to deploy SAP in my company",
    "agent.suggested.formations": "What SAP training do you offer?",
    "agent.suggested.audit": "I need an IT audit",
    "agent.suggested.accompagnement": "How does your support work?",
    "agent.booking.invite": "Great! I suggest booking a 15-minute Google Meet consultation slot with our team.",
    "agent.booking.chooseSlot": "Choose your date and time from the calendar below:",
    "agent.booking.selectDate": "Select a date",
    "agent.booking.availableSlots": "Available slots",
    "agent.booking.confirmSlot": "Confirm this slot",
    "agent.booking.yourSlot": "Your slot",
    "agent.booking.enterEmail": "Enter your email to receive the invitation",
    "agent.booking.emailPlaceholder": "your@email.com",
    "agent.booking.confirmBooking": "Confirm booking",
    "agent.booking.creating": "Creating your meeting...",
    "agent.booking.success": "Meeting confirmed!",
    "agent.booking.date": "Date",
    "agent.booking.email": "Email",
    "agent.booking.joinMeet": "Join Google Meet",
    "agent.booking.successMessage": "Excellent! Your Google Meet meeting has been successfully created! An invitation has been sent to",
    "agent.booking.lookingForward": "I look forward to meeting you for this consultation. We will discuss your needs and present the best A.SAP Consulting solutions for your project.",
    "agent.booking.seeYouSoon": "See you soon!",
    "agent.booking.error": "Sorry, an error occurred while creating the meeting. Please try again or contact us directly.",
